...
我们在方法中相应的形参位置标注了@Param("userName") String name，然后xml映射文件中sql语句，我们是user_name = #{userName}。那么当外部调用方法传入userName具体的值时，相应的sql语句中user_name的值就是我们传入的值。
